    ...
    <header class="header">
        ...
        <div class="navbar">
            ...
            <div class="navbar-menu-container">
                ...
                <a href="javascript:void(0)" class="navbar-link" @click="modalFlag=true" v-if="!nickName">Login</a>
        ...
        <div class="md-modal modal-msg md-modal-transition " v-bind:class="{'md-show':modalFlag}">
            <div class="md-modal-inner">
                <div class="md-top">
                    ...
                    <button class="md-close" @click="modalFlag=false">Close</button>                    
                </div>
                <div class="md-content">
                    <div class="confirm-tips">
                        <div class="error-wrap">
                            <span class="error" v-bind:class="{'error-show':errorTip}">用户名或者密码错误</span>
                        </div>
                        <ul>
                            <li class="regi_form_input">
                                <i class="icon IconPeople"></i>
                                <!-- tabindex指定tab键顺序 placeholder提供可描述输入字段的提示信息-->
                                <input type="text" tabindex="1" name="loginname" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname" v-model="uerName">
                            </li>
                    ...
                    <div>
                        <a href="javascript:;" tabindex="3" class="btn-login" @click="login">登 录</a>
                    </div>
                </div>
            </div>
        </div>
